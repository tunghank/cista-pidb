...
// full day names
Calendar._DN = new Array("Vas�rnap", "H�tf�", "Kedd", "Szerda", "Cs�t�rt�k",
...
// short day names
Calendar._SDN = new Array("v", "h", "k", "sze", "cs", "p", "szo", "v");

// full month names
Calendar._MN = new Array("janu�r", "febru�r", "m�rcius", "�prilis", "m�jus",
		"j�nius", "j�lius", "augusztus", "szeptember", "okt�ber", "november",
		"december");

// short month names
Calendar._SMN = new Array("jan", "feb", "m�r", "�pr", "m�j", "j�n", "j�l",
		"aug", "sze", "okt", "nov", "dec");
...
Calendar._TT["ABOUT"] = "DHTML d�tum/id� kiv�laszt�\n"
