...
// full day names
Calendar._DN = new Array("Sekmadienis", "Pirmadienis", "Antradienis",
		"Tre�iadienis", "Ketvirtadienis", "Pentadienis", "�e�tadienis",
		"Sekmadienis");
...
// short day names
Calendar._SDN = new Array("Sek", "Pir", "Ant", "Tre", "Ket", "Pen", "�e�",
		"Sek");

// full month names
Calendar._MN = new Array("Sausis", "Vasaris", "Kovas", "Balandis", "Gegu��",
		"Bir�elis", "Liepa", "Rugpj�tis", "Rugs�jis", "Spalis", "Lapkritis",
		"Gruodis");

// short month names
Calendar._SMN = new Array("Sau", "Vas", "Kov", "Bal", "Geg", "Bir", "Lie",
		"Rgp", "Rgs", "Spa", "Lap", "Gru");
