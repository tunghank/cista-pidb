...
// full day names
Calendar._DN = new Array("Sv�tdiena", "Pirmdiena", "Otrdiena", "Tre�diena",
		"Ceturdiena", "Piektdiena", "Sestdiena", "Sv�tdiena");
...
// short day names
Calendar._SDN = new Array("Sv", "Pr", "Ot", "Tr", "Ce", "Pk", "Se", "Sv");

// full month names
Calendar._MN = new Array("Janv�ris", "Febru�ris", "Marts", "Apr�lis", "Maijs",
		"J�nijs", "J�lijs", "Augusts", "Septembris", "Oktobris", "Novembris",
		"Decembris");

// short month names
Calendar._SMN = new Array("Jan", "Feb", "Mar", "Apr", "Mai", "J�n", "J�l",
		"Aug", "Sep", "Okt", "Nov", "Dec");
