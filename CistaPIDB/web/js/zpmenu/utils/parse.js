...
Zapatec.Parse.prototype.NF = function(s) {
	return this.arr.length
}

// check if field number is in range, 0 to N-1
Zapatec.Parse.prototype.validField = function(iFld) {
	return iFld >= 0 && iFld <= this.NF() - 1
}

// get the field based on the field number
Zapatec.Parse.prototype.getField = function(iFld) {
	if (!this.validField(iFld))
		return undefined
...
Zapatec.Parse.prototype.pushField = function(value) {
	this.arr.push(value)
}

// pop field off array
Zapatec.Parse.prototype.popField = function(value) {
	return this.arr.pop()
}

// Add field into list a,b,d,e addField(2,0,c) --> a,b,c,d,e
Zapatec.Parse.prototype.insertField = function(iFld, value) {
	this.arr.splice(iFld, 0, value)
}
