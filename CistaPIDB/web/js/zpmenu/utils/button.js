 ...
 * on mouseout. Default value � null. width | [int] Button width. Default value -
 * null. height | [int] Button height. Default value - null. className |
 * [string] Default class to apply to newly created | button. Default value �
 * null. style | [string] Default style to apply to newly created button. |
 * Default value � null. text | [string] Text title to display on button. If |
 * �image� option was given � this text will be used as | alternative title.
 * preloadImages | [boolean] If true � preload all images (image, overImage, |
 * outImage, downImage) for button. Default value � true. overStyle | [string]
 * Style to apply to button during mouseover event. | Default value � null.
 * overClass | [string] Class to add to button during mouseover event. | Default
 * value � null. overImage | [string] Show this image during mouseover event.
 * This | will be done only if �image� option was specified. | Default value �
 * null. overAction | [function] Call this function during mouseover event. |
 * Default value � null. outAction | [function] Call this function during
 * mouseout event. | Default value � null. downStyle | [string] Style to apply
 * to button during mousedown event. | Default value � null. downClass |
 * [string] Class to add to button during mousedown event. | Default value �
 * null. downImage | [string] Show this image during mousedown event. This |
 * will be done only if �image� option was specified. | Default value � null.
 * downAction | [function] Call this function during mousedown event. | Default
 * value � null. clickAction | [function] Call this function during onclick
