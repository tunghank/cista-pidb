 ...
 * 
 * <p>
 * <strong> Note: This function should not be called from another function. It
 * must be invoked during page load to determine path to js file from which it
 * is called correctly. </strong>
 * </p>
 * 
 * @private
...
Zapatec.include(Zapatec.zapatecPath + '../src/zpmenu.js');
