...
/**
 * @ignore Loads data from the HTML source. Transforms input data from the
 *         HTMLElement object. If needed, loadDataHtmlText, loadDataJson and
 *         loadDataXml methods can be implemented as well.
 * 
 * @param {object}
 *            objSource HTMLElement object
 */
