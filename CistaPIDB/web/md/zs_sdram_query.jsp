...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="pageTitle">Master Data :: SDRAM Query</td>
  </tr>
</table>
	<div class="content">
	<form id="masterDataQueryForm" action="<%=cp%>/md/zs_sdram_query.do?m=query" method="post">
				...
				<tbody>
					...
					<th width="180">SDRAM Vendor</th>
					  <% 
						...
						%>
						<td><input class="text" type="text" readonly id="sdramVendor" name="sdramVendor"  value=""  width="150px"> <img
							src="<%=cp%>/images/lov.gif" alt="LOV" id="sdramVendorSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"sdramVendorSSBtn",
                                inputField:"sdramVendor",
