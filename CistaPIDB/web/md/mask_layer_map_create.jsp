...
<form name="updateForm" action="<%=cp %>/md/mask_layer_map_create.do?m=save" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Master Data :: Create Mask Layer Mapping</td>
				</tr>
			</table>
			<div class="content">
				...
				<tbody>
					<tr>
						<th width="20%"><div><span class="star">*</span> Mask No.</div></th>
					 	<td width="30%"><input class="text_required" type="text" id="maskNum" name="maskNum" value="<%=BeanHelper.getHtmlValueByColumn(ref, "MASK_NUM") %>" width="150px"></td>
