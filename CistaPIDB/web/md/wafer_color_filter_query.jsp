...
<body>
<form id="cpMaterialQueryForm" action="<%=cp %>/md/wafer_color_filter_query.do?m=query" method="post">	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="pageTitle">Master Data :: Wafer Color Filter Query</td>
  </tr>
</table>
			<div class="content">
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					<tr>
						<th width="180"><div>WAFER CF MATERIAL Num.</div></th>
					  <td><input class="text" type="text" id="waferCfMaterialNum" name="waferCfMaterialNum">
					  <img src="<%=cp%>/images/lov.gif" alt="LOV" id="waferCfMaterialNumSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"waferCfMaterialNumSSBtn",
                                inputField:"waferCfMaterialNum",
								title:"WAFER CF MATERIAL Num",
					...
					<tr>
						<th width="180">WAFER CF VARIANT</th>
					  <td><input class="text" type="text" id="waferCfVariant" name="waferCfVariant" >
					  <img src="<%=cp%>/images/lov.gif" alt="LOV" id="waferCfVariantSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"waferCfVariantSSBtn",
                                inputField:"waferCfVariant",
                                table:"PIDB_WAFER_CF_MATERIAL",
                                keyColumn:"WAFER_CF_VARIANT",
                                title:"WAFER CF VARIANT",
                                mode:1
							});
