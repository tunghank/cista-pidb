...
<body>
<form id="cpMaterialQueryForm" action="<%=cp %>/md/cp_polish_material_query.do?m=query" method="post">	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="pageTitle">Master Data :: CP Polish Material Query</td>
  </tr>
</table>
			<div class="content">
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					<tr>
						<th width="180"><div>CP Polish Material Num.</div></th>
					  <td><input class="text" type="text" id="cpPolishMaterialNum" name="cpPolishMaterialNum">
					  <img src="<%=cp%>/images/lov.gif" alt="LOV" id="cpPolishMaterialNumSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"cpPolishMaterialNumSSBtn",
                                inputField:"cpPolishMaterialNum",
								title:"CP Polish Material Number",
					...
					<tr>
						<th width="180">CP POLISH VARIANT</th>
					  <td><input class="text" type="text" id="cpPolishVariant" name="cpPolishVariant" >
					  <img src="<%=cp%>/images/lov.gif" alt="LOV" id="cpPolishVariantSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"cpPolishVariantSSBtn",
                                inputField:"cpPolishVariant",
                                table:"PIDB_CP_POLISH_MATERIAL",
                                keyColumn:"CP_POLISH_VARIANT",
                                title:"CP POLISH VARIANT",
                                mode:1
							});
