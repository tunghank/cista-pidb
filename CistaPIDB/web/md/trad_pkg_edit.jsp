...
function doSave() {
		...
		setMessage("error", "Updating traditional package...");	
...
<body>
<% 
	TradPkgTo ref = (TradPkgTo)request.getAttribute("tradPkgTo");	
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
		<td class="pageTitle">Master Data :: Modify Traditional Package</td>
		
  </tr>
</table>
			<div class="content">
			<form id="createForm" action="<%=cp%>/md/trad_pkg_edit.do" method="post">
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					...
					<tr>
						...
						<td>
						<input class="text" type="text" name="tradPkgType" id="tradPkgType"
