...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="pageTitle">Master Data :: WLM Material Query</td>
  </tr>
</table>
<div class="content">
		<form id="masterDataQueryForm" action="<%=cp%>/md/wlm_query.do?m=query" method="post">
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					...
					<tr>
					  ...
					  <td><input class="text" name="packageCode" id="packageCode" type="text">
				      <img src="<%=cp%>/images/lov.gif" alt="LOV" id="packageCodeBtn">
				      <script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"packageCodeBtn",
                                inputField:"packageCode",
                                title:"Package Code",
                                table:"PIDB_WLM",
                                keyColumn:"PACKAGE_CODE",                              
                                mode:1
							});
							</script>
				      </td>
