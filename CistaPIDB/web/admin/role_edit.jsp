...
<%
	RoleTo roleTo = (RoleTo) request.getAttribute("roleTo");
%>
<html>
<head>
<!-- This is header -->
...
var oldRoleName = '<%=BeanHelper.getHtmlValueByColumn(roleTo, "ROLE_NAME")%>';
function updateRole() {
	if ($F('roleName') == "") {
	...
	function checkRoleExistComplete(r) {
		...
		if(result=="true" && $F('roleName')!=oldRoleName) {
...
<body>
<form name="roleUpdate" action="<%=cp %>/admin/role_edit.do?m=save" method="post">
<input type="hidden" id="id" name="id" value="<%=BeanHelper.getHtmlValueByColumn(roleTo, "ID")%>">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="pageTitle">Admin :: Role management</td>
			...
			<div class="content">
			<div class="segmentHeader">Role Edit </div>
				...
				<tr>
					...
					<div align="right">
					  <input
						...
						value="Update" onclick="updateRole()">
					  <input
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					<tr>
					  ...
					  <td>
							<input name="roleName" id="roleName" type="text" size="30" class="text" value="<%=BeanHelper.getHtmlValueByColumn(roleTo, "ROLE_NAME")%>">
					  </td>
					</tr>
					<tr>
