...
<body>
<form name="functionCreate" action="<%=cp %>/admin/function_create.do?m=save" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="pageTitle">Admin :: Function management</td>
			...
			<div class="content">
			<div class="segmentHeader">Function Create </div>
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					<tr>
					  ...
					  <td>
							<input name="funcName" id="funcName" type="text" size="30" class="text" value="">
					  </td>
					</tr>
					<tr>
					...
					<tr>
					  ...
					  <td>
							<input name="position" id="position" type="text" size="30" class="text" value="">
					  </td>
					</tr>										
					<tr>
					  <th width="180" style="vertical-align: top;">URI Pattern</th>
					  <td>
					  <input type="hidden" id="uriPattern" name="uriPattern">
