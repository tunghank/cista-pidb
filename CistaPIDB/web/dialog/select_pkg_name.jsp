...
<%
	List<String> pkgNameList = (List)request.getAttribute("pkgNameList");
%>
<html>
<head>
<!-- This is header -->
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Package Name</td>
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=pkgNameList==null || pkgNameList.size()==0?"No Package Name.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
