...
<%
	List<String> materialNumList = (List)request.getAttribute("materialNumList");
%>
<html>
<head>
<!-- This is header -->
...
<body>
<form name="selectForm" action="<%=cp %>/dialog/select_material_num.do?m=pre" method="post">
	...
	<tbody>
		<tr>
			...
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=materialNumList==null || materialNumList.size()==0?"No material number.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
...
<div id="resultPanel" style="overflow:auto;width:100px;height:100px">
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					int idx = 0;
					for(String item : materialNumList) {
						idx ++;
