...
<%
	List<String> projCustList = (List)request.getAttribute("projCustList");
%>
<html>
<head>
<!-- This is header -->
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Project Customer</td>
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=projCustList==null || projCustList.size()==0?"No project customer.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
	if(projCustList != null && projCustList.size() > 0) {
%>
