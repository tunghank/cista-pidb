...
<%
	List<ProductTo> toList = (List)request.getAttribute("selectList");
%>
<html>
<head>
<!-- This is header -->
...
<body>
<form name="selectSmc" action="<%=cp %>/dialog/select_prodName_radio.do" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Product Name</td>
				</tr>
			</table>
			<div class="content">
...
<div id="resultPanel" style="overflow:auto;width:100px;height:100px">
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					int idx = 0;
					for(ProductTo to : toList) {
						idx ++;
						String tdcss = "class=\"c" + idx % 2+"\"";
						String userStr = to.getProdName();
						%>
				<tr>
