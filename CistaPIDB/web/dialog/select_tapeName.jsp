...
<body>
<form name="selectRes" action="<%=cp%>/dialog/select_tapeName.do" method="post">
...
<table border=0 cellpadding=0 cellspacing=0 width="100%"><tr><td>
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<td <%=tdcss %>><%=to.getTapeName() %></td>
					<td <%=tdcss %>><%=to.getTapeVariant() %></td>
					<td <%=tdcss %>><%=to.getTapeType() %></td>
					<td <%=tdcss %>><%=to.getTapeVendor() %></td>
				</tr>
						<%
					}
				%>
