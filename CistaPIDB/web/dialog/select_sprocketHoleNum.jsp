...
<%
	List<IcTapeTo> toList = (List)request.getAttribute("selectList");
%>
<html>
<head>
<!-- This is header -->
...
<script type="text/javascript">
	...
	function onSelect() {
		if (callback!="") {
			...
			var allItem = document.getElementsByName("chk");
...
<body>
<form name="selectForm" action="<%=cp %>/dialog/select_sprocketHoleNum.do?m=pre" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Sprocket Hole No.</td>
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=toList==null || toList.size()==0?"No project code.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
...
<div id="resultPanel" style="overflow:auto;width:100px;height:100px">
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<tr>
					<th>&nbsp;</th>
					<th>Sprocket Hole No.</th>
				</tr>
				<%
					int idx = 0;
					for(IcTapeTo to : toList) {
						idx ++;
						String tdcss = "class=\"c" + idx % 2+"\"";
						if (to == null) {
							break;
						}
						String chk = (to.getSprocketHoleNum()==null)? "" :  to.getSprocketHoleNum();
						%>
				<tr>
					<td <%=tdcss %>><input type="checkbox" value="<%=chk %>" name="chk"></td>
					<td <%=tdcss %>><%=chk %></td>
				</tr>
						<%
					}
