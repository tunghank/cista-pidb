...
<%
	List<MaskLayerMappingTo> toList = (List)request.getAttribute("selectList");
%>
<html>
<head>
<!-- This is header -->
...
<body>
<form name="selectRes" action="<%=cp%>/dialog/select_maskNum.do" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Mask Number</td>
				</tr>
			</table>
			<div class="content">
...
<div id="resultPanel" style="overflow:auto;width:100px;height:100px">
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					int idx = 0;
					for(MaskLayerMappingTo to : toList) {
						idx ++;
						String tdcss = "class=\"c" + idx % 2+"\"";
						String chk = to.getMaskNum();
						%>
				<tr>
					<td <%=tdcss %>><input type="checkbox" value="<%=chk %>" name=chkbox></td>
					<td <%=tdcss %>><%=to.getMaskNum() %></td>
				</tr>
						<%
					}
				%>
