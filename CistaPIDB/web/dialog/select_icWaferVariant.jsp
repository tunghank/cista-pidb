	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Create Variant</td>
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=polishList==null || polishList.size()==0?"No Data.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
...
<div id="resultPanel" style="overflow:auto;width:100px;">
			...
			<tr><td>
						<table id="TbEOLCustList" class="grid" border="0" cellpadding="1" cellspacing="1">
							<tbody>
							<tr>
								<th>CP_POLISH_MATERIAL_NUM</th>
								<th>PROJECT_CODE_W_VERSION</th>
								<th>DESCRIPTION</th>
								<th>CP_POLISH_VARIANT</th>
							</tr>
							</tbody>
						<%if (polishList != null && polishList.size() > 0) {%>
							<%
								...
								for(CpPolishMaterialTo polish : polishList) {					
										if ( polish != null ){
											CpPolishMaterialTo to = new CpPolishMaterialTo();
											CpPolishMaterialDao dao = new CpPolishMaterialDao();
											to = dao.findPolishMaterial()
										}
								idx ++;
