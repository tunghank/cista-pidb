...
<%
	List<String> pkgCodeList = (List)request.getAttribute("pkgCodeList");
%>
<html>
<head>
<!-- This is header -->
	...
	<tbody>
		<tr>
			...
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=pkgCodeList==null || pkgCodeList.size()==0?"No Package Code.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
	if(pkgCodeList != null && pkgCodeList.size() > 0) {
%>
