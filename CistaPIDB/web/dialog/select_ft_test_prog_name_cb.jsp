...
<%
	List<String> smcList = (List)request.getAttribute("selectList");
%>
<html>
<head>
<!-- This is header -->
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select FT Test Program Name</td>
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=smcList==null || smcList.size()==0?"No FT Test Program Name.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
...
<div id="resultPanel" style="overflow:auto;width:100px;height:100px">
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					int idx = 0;
					for(String trim : smcList) {
						idx ++;
						String tdcss = "class=\"c" + idx % 2+"\"";
						trim = (trim == null) ? "" : trim;
						%>
				<tr>
					<td <%=tdcss %>><input type="checkbox" value="<%=trim %>" name=SmcCheckbox></td>
					<td <%=tdcss %>><%=trim %></td>
				</tr>
						<%
					}
