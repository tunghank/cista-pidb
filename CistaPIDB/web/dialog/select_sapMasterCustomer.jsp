	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Customer Code</td>
				</tr>
			</table>
			<div class="content">
			...
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					...
					for(SapMasterCustomerTo smc : smcList) {
						...
						%>
				<tr>
					<td <%=tdcss %>><input type="checkbox" value="<%=smc.getCustomerGrp() %>|<%=smc.getShortName() %>" name=SmcCheckbox></td>
					<td <%=tdcss %>><%=(smc.getShortName()==null)? "" : smc.getShortName() %></td>
					<td <%=tdcss %>><%=(smc.getCustomerGrp()==null)? "" : smc.getCustomerGrp() %></td>
