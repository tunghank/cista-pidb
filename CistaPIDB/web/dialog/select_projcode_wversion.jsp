...
<%
	List<String> projCodeWVersionList = (List)request.getAttribute("projCodeWVersionList");
%>
<html>
<head>
<!-- This is header -->
...
<body>
<form name="selectForm" action="<%=cp %>/dialog/select_proj_code_w_version.do?m=pre" method="post">
	...
	<tbody>
		<tr>
			...
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=projCodeWVersionList==null || projCodeWVersionList.size()==0?"No project code w version.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
	if(projCodeWVersionList != null && projCodeWVersionList.size() > 0) {
%>
...
<div id="resultPanel" style="overflow:auto;width:100px;height:100px">
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					int idx = 0;
					for(String item : projCodeWVersionList) {
						idx ++;
