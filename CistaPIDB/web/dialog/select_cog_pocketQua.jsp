...
<body>
<form name="selectForm" action="<%=cp %>/dialog/select_cog_pocketQua.do" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Cog Pocket Quantity</td>
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=cogList==null || cogList.size()==0?"No Pocket Quantity.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
			...
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					...
					for(String cog : cogList) {
						...
						%>
				<tr>
					<td <%=tdcss %>><input type="checkbox" value="<%=cog %>" name="ProdCheckbox"></td>
					<td <%=tdcss %>><%=cog%></td>
				</tr>
						<%
					}
