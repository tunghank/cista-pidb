...
<body>
<form name="selectForm" action="<%=cp %>/dialog/select_minPitch.do?m=pre" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Min. Pitch</td>
				</tr>
			</table>
			<div class="content">
			...
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					...
					for(IcTapeTo to : toList) {
						...
						String chk = to.getMinPitch();
						%>
				<tr>
					<td <%=tdcss %>><input type="checkbox" value="<%=chk %>" name="chk"></td>
					<td <%=tdcss %>><%=to.getMinPitch() %></td>
				</tr>
						<%
					}
				%>
