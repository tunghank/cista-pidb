...
public class ZsEepromTo {
	...
	public String getWaferInch() {
		return waferInch;
	}
	public void setWaferInch(String waferInch) {
		this.waferInch = waferInch;
	}
	...
	public String getCodeBind() {
		return codeBind;
	}
	public void setCodeBind(String codeBind) {
		this.codeBind = codeBind;
	}
