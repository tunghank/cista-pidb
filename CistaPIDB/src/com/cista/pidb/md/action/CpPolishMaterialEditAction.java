...
public class CpPolishMaterialEditAction extends DispatchAction {

	public ActionForward pre(final ActionMapping mapping,
			final ActionForm form, final HttpServletRequest request,
			final HttpServletResponse response) {
		String forward = "viewJsp";
		String cpPolishMaterial = (String) request
				.getParameter("cpPolishMaterialNum");
		String projCodeWVersion = (String) request
				.getParameter("projCodeWVersion");

		request.setAttribute("ref", new CpPolishMaterialDao().findByPrimaryKey(
				cpPolishMaterial, projCodeWVersion));
	...
	public ActionForward save(final ActionMapping mapping,
		...
		CpPolishMaterialTo polishTo = (CpPolishMaterialTo) HttpHelper.pickupForm(
				CpPolishMaterialTo.class, request, true);
		...
		polishDao.updatePolish(polishTo);
