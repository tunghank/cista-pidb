...
public class WlmCreateAction extends DispatchAction{
	 ...
	 public ActionForward pre(final ActionMapping mapping,
	            ...
	            if (request.getParameter("ref") != null) {
		            ...
		            WlmTo wlmTo = new WlmDao().findByPrimaryKey(meterialNum);
	 ...
	 public ActionForward save(final ActionMapping mapping,
		...
		wlmTo.setCreatedBy(loginUser.getUserId());
		wlmDao.insertWlm(wlmTo);
		//Change Log
		PidbChangeLogDao chlDao = new PidbChangeLogDao();
		chlDao.insertChange("WLM", "INSET", AjaxHelper.bean2String(wlmTo) , loginUser.getUserId());
		//Get Create Data
