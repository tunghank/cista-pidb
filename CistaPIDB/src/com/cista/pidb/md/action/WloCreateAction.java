...
public class WloCreateAction extends DispatchAction{
	 ...
	 public ActionForward pre(final ActionMapping mapping,
	            ...
	            if (request.getParameter("ref") != null) {
		            ...
		            String meterialNum = request.getParameter("ref");
		            WloTo wloTo = new WloDao().findByPrimaryKey(meterialNum);
	 ...
	 public ActionForward save(final ActionMapping mapping,
		...
		wloTo.setCreatedBy(loginUser.getUserId());
		wloDao.insertWlo(wloTo);
		//Change Log
		PidbChangeLogDao chlDao = new PidbChangeLogDao();
		chlDao.insertChange("WLO", "INSET", AjaxHelper.bean2String(wloTo), loginUser.getUserId());
		//Get Create Data
