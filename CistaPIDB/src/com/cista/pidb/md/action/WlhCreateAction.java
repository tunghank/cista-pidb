...
public class WlhCreateAction extends DispatchAction{
	 ...
	 public ActionForward pre(final ActionMapping mapping,
	            ...
	            if (request.getParameter("ref") != null) {
		            ...
		            WlhTo wlhTo = new WlhDao().findByPrimaryKey(meterialNum);
	 ...
	 public ActionForward save(final ActionMapping mapping,
		...
		wlhTo.setCreatedBy(loginUser.getUserId());
		wlhDao.insertWlh(wlhTo);
		//Change Log
		PidbChangeLogDao chlDao = new PidbChangeLogDao();
		chlDao.insertChange("WLH", "INSET", AjaxHelper.bean2String(wlhTo), loginUser.getUserId());
		//Get Create Data
