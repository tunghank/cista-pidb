...
public class SelectPackageCode extends DispatchAction {
    /**
     * .
    ...
    public ActionForward pre(final ActionMapping mapping,
        ...
        request.setAttribute("pkgCodeList", tradPkgDao.findPkgCode());
    ...
    public ActionForward list(final ActionMapping mapping,
        ...
        String callback = request.getParameter("callback");
        TradPkgDao tradPkgDao = new TradPkgDao();
        request.setAttribute("selectList", tradPkgDao.findPkgCode());
        request.setAttribute("callback", callback);
        return mapping.findForward(forward);
    }
}
