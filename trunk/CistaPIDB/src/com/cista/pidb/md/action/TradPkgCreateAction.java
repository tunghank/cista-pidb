...
public class TradPkgCreateAction extends DispatchAction {
	...
	public ActionForward pre(final ActionMapping mapping,
		...
		if (request.getParameter("ref") != null) {
			...
			TradPkgTo tradPkgTo = new TradPkgDao().findByPkgName(pkgName);
	...
	public ActionForward save(final ActionMapping mapping,
		...
		tradPkgTo.setCreatedBy(loginUser.getUserId());
		tradPkgDao.insertTradPkg(tradPkgTo);

		// send mail
		SendMailDispatch.sendMailByCreate("MD-12", tradPkgTo.getPkgName(),
