/**
 * \file preloadimages.js PreloadImages class definition. Preloads one or
 ...
 * 
 * \param objArgs [object] initialization object: { job: [object]
 * Zapatec.PreloadImages object, url: [string] image URL, timeout: [number,
 * optional] number of milliseconds to wait for onload event before forcing it }
 */
 ...
 * receives Zapatec.Transport.PreloadImages object. Its various properies can be
 * used: { images: [object] array of Image objects, loadedUrls: [object] array
 * of successfully loaded URLs, invalidUrls: [object] array of URLs that were
 * not loaded due to errors, abortedUrls: [object] array of URLs that were not
 * loaded due to abort, leftToLoad: [number] how many images left to load if
 * event was forced }
 * 
 * If onLoad event doesn't fire during long period of time, it can be forced
 * using "timeout" argument.
 * 
 * \param objArgs [object] initialization object: { urls: [object] array of
 * absolute or relative image URLs to preload, onLoad: [function, optional]
 * onload event handler, timeout: [number, optional] number of milliseconds to
 * wait for onload event before forcing it }
 */
