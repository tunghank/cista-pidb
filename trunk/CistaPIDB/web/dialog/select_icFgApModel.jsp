...
<body>
<form name="selectForm" action="<%=cp%>/dialog/select_icFgCust.do" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Ap Model</td>
				</tr>
			</table>
			<div class="content">
			...
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					...
					for(IcTapeTo to : toList) {
						...
						String chk = to.getTapeCustProjName();
						%>
				<tr>
					<td <%=tdcss %>><input type="checkbox" value="<%=chk %>" name="chkbox"></td>
					<td <%=tdcss %>><%=to.getTapeCustProjName() %></td>
				</tr>
						<%
					}
				%>
