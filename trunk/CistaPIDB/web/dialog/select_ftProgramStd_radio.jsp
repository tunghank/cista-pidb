...
<body>
<form name="selectSmc" action="<%=cp %>/dialog/select_ftProgramStd_radio.do" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select FT Test Program</td>
				</tr>
			</table>
			<div class="content">
...
<div id="resultPanel" style="overflow:auto;width:100px;height:100px">
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					<td <%=tdcss %>><%=to.getFtCpuTimeE() %></td>
					<td <%=tdcss %>><%=to.getFtIndexTimeE() %></td>
					<td <%=tdcss %>><%=to.getFtTesterE() %></td>
