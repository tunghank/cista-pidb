...
<%
	List<String> toList = (List<String>)request.getAttribute("selectList");
%>
<html>
<head>
<!-- This is header -->
...
<body>
<form name="selectSmc" action="<%=cp %>/dialog/select_product_radio.do" method="post">
			...
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					...
					for(String to : toList) {
						...
						%>
				<tr>
					<td <%=tdcss %>><input type="radio" value="<%=to %>" name=rad></td>
					<td <%=tdcss %>><%=to %></td>
				</tr>
						<%
					}
