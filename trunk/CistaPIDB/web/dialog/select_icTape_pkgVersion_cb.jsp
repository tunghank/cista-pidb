...
<%
	List<IcTapeTo> smcList = (List)request.getAttribute("selectList");
%>
<html>
<head>
<!-- This is header -->
...
<script type="text/javascript">
	...
	function onSelect() {
		if (callback!="") {
			...
			var allItem = document.getElementsByName("SmcCheckbox");
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Package Version</td>
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=smcList==null || smcList.size()==0?"No Package Version.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
...
<div id="resultPanel" style="overflow:auto;width:100px;height:100px">
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					int idx = 0;
					for(IcTapeTo smc : smcList) {
						idx ++;
						String tdcss = "class=\"c" + idx % 2+"\"";
						if (smc == null) {
							break;
						}
						String userStr = smc.getPkgVersion();
						if (userStr == null ) {
							userStr = "";
						}
						%>
