...
<%
	List<HtolRaTo> toList = (List)request.getAttribute("selectList");
%>
<html>
<head>
<!-- This is header -->
...
<body>
<form name="selectForm" action="<%=cp %>/dialog/select_HtolProjCodeWVersion.do?m=pre" method="post">
...
<div id="resultPanel" style="overflow:auto;width:100px;height:100px">
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<%
					int idx = 0;
					for(HtolRaTo to : toList) {
						idx ++;
						String tdcss = "class=\"c" + idx % 2+"\"";
						if (to == null) {
							break;
						}
						String chk = (to.getProjCodeWVersion()==null)? "" :  to.getProjCodeWVersion();
						%>
				<tr>
