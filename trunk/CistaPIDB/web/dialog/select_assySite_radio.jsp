...
<%
	List<FunctionParameterTo> smcList = (List)request.getAttribute("selectList");
...
<body>
<form name="selectRes" action="<%=cp%>/dialog/select_assySite.do?m=list" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Assembly Site</td>
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=smcList==null || smcList.size()==0?"No Assembly Site.":"" %>&nbsp;</div>
					</td>
				</tr>
				<tr>
					<td>
					<input type="text" class="text" name="condition" value="<%=condition!=null?condition:"" %>">
...
<table border=0 cellpadding=0 cellspacing=0 width="100%"><tr><td>
			<table class="grid" border="0" cellpadding="1" cellspacing="1">
				...
				<tr>
					<th>&nbsp;</th>
					<th>FIELD_VALUE</th>
					<th>FIELD_SHOW_NAME</th>
					<th>ITEM</th>
				</tr>
				<%
					int idx = 0;
					for(FunctionParameterTo smc : smcList) {
						idx ++;
						...
						%>
				<tr>
					<td <%=tdcss %>><input type="checkbox" value="<%=smc.getFieldValue() %>" name=SmcCheckbox></td>
					<td <%=tdcss %>><%=(smc.getFieldValue()==null)? "" : smc.getFieldValue() %></td>
					<td <%=tdcss %>><%=(smc.getFieldShowName()==null)? "" : smc.getFieldShowName() %></td>
					<td <%=tdcss %>><%=(smc.getItem()==null)? "" : smc.getItem() %></td>
