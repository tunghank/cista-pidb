...
<%
	List<String> projNameList = (List)request.getAttribute("projNameList");
%>
<html>
<head>
<!-- This is header -->
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Dialog :: Select Project Name</td>
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					<td>
					<div class="formErrorMsg" id="error"><html:errors/><!--ErrorMessage--><%=projNameList==null || projNameList.size()==0?"No project name.":"" %>&nbsp;</div>
					</td>
				</tr>
			</table>
<%
