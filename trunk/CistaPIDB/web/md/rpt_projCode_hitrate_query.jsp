...
* 2010.04.21/FCG2 @Jere Huang - 修改reset功能, 新增NTO Date
------------------------------------------------------------------------------->
...
<%
	...
	String reqProjCode = (String) request.getAttribute("reqProjCode");
...
function onQuery()
{
	...
	var projCode = $("projCode").value;
	var prodLine = $("prodLine").value;

	if(prodFamily=="" && projName == "" && projCode == "" && prodLine=="")
	{
...
<body>
<form name="proCodejHitrateForm" id="proCodejHitrateForm" action="<%=cp %>/md/rpt_projCode_hitrate_query.do?m=query" method="post">
		...
		<tr>
		  <td valign="top" bgcolor="#FFFFFF"><!--Html Start--> <!-- This is header -->		  
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			     <tr>
				     <td class="pageTitle">Project Code HitRate Data :: Project code HitRate Query</td>				  
				  </tr>
			  </table> 
			  ...
			  <div class="content">		  
				  ...
				  <tbody>					
						<tr>
						  ...
						  <th width="80"><div>Project Code&#13;</div></th>
						  <td width="150">
							 <input type="text" class="text" name="projCode" id="projCode" value="<%=projCode%>"> 
							 <img id="projCodeBtn" src="<%=cp%>/images/lov.gif" alt="LOV">
							 <script type="text/javascript">
							   SmartSearch.setup({cp:"<%=cp%>", button:"projCodeBtn", inputField:"projCode", name:"ProjectCode", mode:1});
				          </script>  	  							
						  </td>						 						  
			         </tr>
			         <tr>
