...
function doSave() {
	...
	setMessage("error", "Checking RW exist...");
	new Ajax.Request(
		'<%=cp%>/ajax/check_rw_exist.do',
		{
			method: 'get',			
			parameters: 'pkgCode='+ $F('pkgCode') + '&prodCode='+ $F('prodCode'),			
			onComplete: checkRwExistComplete
		}
	);
}

function checkRwExistComplete(r) {
	...
	if(result=="true") {
		...
		$('resetBtn').disabled = false;
			...
			$('rwCreateForm').action = $('rwCreateForm').action + "?m=save";
			$('rwCreateForm').submit();
	}
}
...
<body>
<form name="rwCreateForm" action="<%=cp %>/md/rw_create.do" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Master Data :: Create RW</td>					
				</tr>
			</table>
			<div class="content">
