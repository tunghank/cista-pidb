...
function doSave() {
		...
		setMessage("error", "Updating WLM Material...");	
...
<body>
<% 
	WlmTo ref = (WlmTo)request.getAttribute("wlmTo");
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
		<td class="pageTitle">Master Data :: Modify WLM Material</td>
		
  </tr>
</table>
			<div class="content">
			<form id="createForm" action="<%=cp%>/md/wlm_edit.do" method="post">
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					...
					<tr>
						...
						value="<%=BeanHelper.getHtmlValueByColumn(ref,"RESERVED") %>" size='1'></td>
						<th width="20%">&nbsp;</th>
					    <td width="30%">&nbsp;</td>
					</tr>
					...
					<tr>
					    ...
					    <td width="30%">
						<input class="text_protected" type="text" name="packageCode" id="packageCode" readonly
						value="<%=BeanHelper.getHtmlValueByColumn(ref,"PACKAGE_CODE") %>">
						</td>
						<th width="20%">&nbsp;</th>
					  	<td width="30%">&nbsp;</td>
