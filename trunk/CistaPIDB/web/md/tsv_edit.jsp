...
function doSave() {
		...
		setMessage("error", "Updating TSV package...");	
...
<body>
<% 
	TsvTo ref = (TsvTo)request.getAttribute("tsvTo");	
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
		<td class="pageTitle">Master Data :: Modify TSV Package</td>
		
  </tr>
</table>
			<div class="content">
			<form id="createForm" action="<%=cp%>/md/tsv_edit.do" method="post">
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					...
					<tr>
						...
						<td>
						<input class="text" type="text" name="tsvType" id="tsvType"
