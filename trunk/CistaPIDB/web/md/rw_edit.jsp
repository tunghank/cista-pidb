...
<%
	RwTo ref = (RwTo) request.getAttribute("ref");
%>
<html>
<head>
<!-- This is header -->
...
<body>
<form name="rwCreateForm" action="<%=cp %>/md/rw_edit.do?m=save" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Master Data :: Modify RW</td>					
				</tr>
			</table>
			<div class="content">
			<table class="formErrorAndButton">
				<tr>
					...
					<td>
					<div align="right">
					Created by <input name="createdBy" id="createdBy" type="text" class="text_protected" readonly value="<%=BeanHelper.getHtmlValueByColumn(ref, "CREATED_BY") %>">&nbsp;&nbsp;
					Modified by <input name="modifiedBy" id="modifiedBy" type="text" class="text_protected" readonly value="<%=BeanHelper.getHtmlValueByColumn(ref, "MODIFIED_BY") %>">&nbsp;&nbsp;</div>
					</td>
				</tr>
			</table>
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					<tr>
						...
						<td width="30%"><input type="text" class="text_protected"
							name="prodCode" id="prodCode" width="150px" readonly value="<%=BeanHelper.getHtmlValueByColumn(ref, "PROD_CODE") %>">
							&nbsp;&nbsp;</td>
						<td rowspan="4"><table class="formFull" border="1" cellpadding="1" cellspacing="1">
                            <tr>
                              <td><table class="formFull" border="0" cellpadding="1" cellspacing="1">
                                  <tr>
                                    <th width="200">Tray Drawing No. (1)</th>
                                  ...
                                  <tr>
                                    <th width="200">Tray Drawing No. Ver. (1)</th>
							...
							name="color1" id="color1"></td>
                                  ...
                                  <tr>
                                    <th width="200">RW Customer Name (1)</th>
                                    <td><input type="text" class="text" value="<%=BeanHelper.getHtmlValueByColumn(ref, "RW_CUST_NAME1") %>"
							name="rwCustName1" id="rwCustName1" ></td>
                                  </tr>
                              </table></td>
                            </tr>
						  </table></td>
					...
					<tr>
						...
						<td><input type="text" class="text_protected"
							name="pkgCode" id="pkgCode" readonly value="<%=BeanHelper.getHtmlValueByColumn(ref, "PKG_CODE") %>" maxlength="6"></td>
					</tr>
					<tr>
						<th>Tray Size</th>
					...
					<tr>
						...
						<th rowspan="4"> <table class="formFull" border="1" cellpadding="1" cellspacing="1">
                            <tr>
                              <td><table class="formFull" border="0" cellpadding="1" cellspacing="1">
                                  <tr>
							...
							name="color2" id="color2"></td>
                                  ...
                                  <tr>
                                    <th width="200">RW Customer Name (2)</th>
                                    <td><input type="text" class="text" value="<%=BeanHelper.getHtmlValueByColumn(ref, "RW_CUST_NAME2") %>"
							name="rwCustName2" id="rwCustName2" ></td>
                                  </tr>
                              </table></td>
                            </tr>
                        </table></th>
					...
					<tr>
						...
						<td><select name="assySubcon1" id="assySubcon1" class="select_w130">
						    <option value="">--Select--</option>
					...
					<tr>
						...
						<td><select name="assySubcon2"
							id="assySubcon2" class="select_w130">
							<option value="">--Select--</option>
						...
						<th rowspan="4"><table class="formFull" border="1" cellpadding="1" cellspacing="1">
							...
							name="color3" id="color3"></td>
                                  ...
                                  <tr>
                                    <th width="200">RW Customer Name (3)</th>
                                    <td><input type="text" class="text" value="<%=BeanHelper.getHtmlValueByColumn(ref, "RW_CUST_NAME3") %>"
							name="rwCustName3" id="rwCustName3" ></td>
                                  </tr>
                              </table></td>
                            </tr>
                        </table></th>
					...
					<tr>
						...
						<td> <select name="assySubcon3"
							id="assySubcon3"  class="select_w130">
							<option value="">--Select--</option>
					...
					<tr>
						...
						<td><select name="assySubcon4"
							...
							<option value="KYEC" <%="KYEC".equals(BeanHelper.getHtmlValueByColumn(ref, "ASSY_SUBCON4"))?"selected":"" %>>KYEC</option>
						</select> </td>
					</tr>
					...
					<tr>
						...
						<th rowspan="3"><table class="formFull" border="1" cellpadding="1" cellspacing="1">
                            <tr>
                              <td><table class="formFull" border="0" cellpadding="1" cellspacing="1">
                                  <tr>
							...
							name="color4" id="color4"></td>
                                  ...
                                  <tr>
                                    <th width="200">RW Customer Name (4)</th>
                                    <td><input type="text" class="text" value="<%=BeanHelper.getHtmlValueByColumn(ref, "RW_CUST_NAME4") %>"
							name="rwCustName4" id="rwCustName4" ></td>
                                  </tr>
                              </table></td>
                            </tr>
                        </table></th>
					...
					<tr>
					  ...
					  <th rowspan="4"><table class="formFull" border="1" cellpadding="1" cellspacing="1">
							...
							name="color5" id="color5"></td>
                                  ...
                                  <tr>
                                    <th width="200">RW Customer Name (5)</th>
                                    <td><input type="text" class="text" value="<%=BeanHelper.getHtmlValueByColumn(ref, "RW_CUST_NAME5") %>"
							name="rwCustName5" id="rwCustName5" ></td>
                                  </tr>
                              </table></td>
                            </tr>
                        </table></th>
					...
					<tr>
						...
						<th rowspan="4"><table class="formFull" border="1" cellpadding="1" cellspacing="1">
							...
							name="color6" id="color6"></td>
                                  ...
                                  <tr>
                                    <th width="200">RW Customer Name (6)</th>
                                    <td><input type="text" class="text" value="<%=BeanHelper.getHtmlValueByColumn(ref, "RW_CUST_NAME6") %>"
							name="rwCustName6" id="rwCustName6" ></td>
                                  </tr>
                              </table></td>
                            </tr>
                        </table></th>
