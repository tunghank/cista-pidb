...
var oldProdName = '<%=BeanHelper.getHtmlValueByColumn(ref, "PROD_NAME")%>';
var oldPkgCode = '<%=BeanHelper.getHtmlValueByColumn(ref, "PKG_CODE")%>';
var oldPkgVersion = '<%=BeanHelper.getHtmlValueByColumn(ref, "PKG_VERSION")%>';
var oldTapeVariant = '<%=BeanHelper.getHtmlValueByColumn(ref, "TAPE_VARIANT")%>';
...
function doSave(s) {
	...
	if ($F('pkgVersion') == "") {
		setMessage("error", "IC Tape Version is must field.");
		return;
	}
	...
	new Ajax.Request(
		...
		{
			method: 'get',
			parameters: 'prodName='+ $F('prodName') + '&pkgCode=' + $F('pkgCode') + '&pkgVersion=' + $F('pkgVersion') + '&tapeVariant=' + $F('tapeVariant') + '&tapeName=' + $F('tapeName'),
...
function checkIcTapeExistComplete(r) {
	...
	if(result == "pkgcodeerror") {
		...
		$('saveBtn').disabled = false;
		$('resetBtn').disabled = false;
	} else if(result=="true" && $F('prodName')!= oldProdName && $F('pkgCode')!= oldPkgCode && $F('pkgVersion')!= oldPkgVersion && $F('tapeVariant')!= oldTapeVariant) {
...
<form name="icTapeForm" action="<%=cp %>/md/ic_tape_edit.do?m=save" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Master Data :: Modify IC-Tape</td>
				</tr>
			</table>
			<div class="content">
				...
				<tbody>
					<tr>
						<th width="20%"><div class="erp_label">Material Number</div></th>
					 	<td width="30%"><input class="text_protected" type="text" readonly="true" id="materialNum" name="materialNum" value="<%=BeanHelper.getHtmlValueByColumn(ref, "MATERIAL_NUM") %>" width="150px"></td>
					...
					<tr>
						<th width="20%"><div class="erp_label"><span class="star">*</span> Tape Name (請加版本)</div></th>
					  	<td width="30%"><input class="text_protected" type="text" readonly id="tapeName" name="tapeName"  value="<%=BeanHelper.getHtmlValueByColumn(ref, "TAPE_NAME") %>"  width="150px"></td>
					...
					<tr>
						<th width="20%"><div>Tape Variant</div></th>
					  	<td width="30%"><input class="text_protected" type="text"  readonly="true" id="tapeVariant" name="tapeVariant" value="<%=BeanHelper.getHtmlValueByColumn(ref, "TAPE_VARIANT") %>" width="150px"></td>
					...
					<tr>
						<th width="20%"><div class="erp_label"><span class="star">*</span> Product Name</div></th>
					  	<td width="30%"><input class="text_protected" type="text" readonly id="prodName" name="prodName"  value="<%=BeanHelper.getHtmlValueByColumn(ref, "PROD_NAME") %>"  width="150px" >
					  	</td>
					...
					<tr>
						<th width="20%"><div><span class="star">*</span> Package Code</div></th>
					  	<td width="30%"><input class="text_protected" type="text" readonly id="pkgCode" name="pkgCode"  value="<%=BeanHelper.getHtmlValueByColumn(ref, "PKG_CODE") %>" maxlength="4"  width="150px" ></td>
					...
					<tr>
						<th width="20%"><div><span class="star">*</span> Tape Version</div></th>
					  	<td width="30%"><input class="text_protected" type="text" readonly id="pkgVersion" name="pkgVersion"  value="<%=BeanHelper.getHtmlValueByColumn(ref, "PKG_VERSION") %>" maxlength="1"  width="150px"></td>
					...
					<tr>
						<th width="20%"><div>Status</div></th>
					  	<td width="30%"><input class="text_protected" type="text" id="status" name="status" readonly value="<%=BeanHelper.getHtmlValueByColumn(ref, "STATUS") %>" width="150px">
					  	</td>							
					</tr>		
					<tr>
					...
					<tr>
						...
						<th width="20%"><div>Cu thickness-Pattern site (um)</div></th>
					  	<td width="30%"><label> <input type="text" readonly name="cuThicknessPattern" id="cuThicknessPattern" value="<%=BeanHelper.getHtmlValueByColumn(ref, "CU_THICKNESS_PATTERN") %>" class="text_required">
						<img
