<!-- Header---------------------------------------------------------------------
* 2010.02.26/FCG1 @Jere Huang - Initial Version.
...
{	
  ...
  //export excel
   ...
   var tapeOutGrid = new Ext.grid.EditorGridPanel(
 	{
   	ds: tapeOutStore,
      cm: tapeOutCM,        
   ...
   {
	   cell.attr = "style=background-color:#87CEFA";
		return data;
   }
}); //end Ext.onReady
...
<style type="text/css">
   .x-grid3-hd-inner{background-color:#F0C1FF;}
...
<body>
<form name="prodTapeOutForm" id="prodTapeOutForm" action="<%=cp %>/md/rpt_prod_tapeout_query.do?m=query" method="post">
		...
		<tr>
		  <td valign="top" bgcolor="#FFFFFF"><!--Html Start--> <!-- This is header -->		  
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			     <tr>
				     <td class="pageTitle">Tape Out Data :: Tape Out Query</td>
				  </tr>
			  </table> 
			  ...
			  <div class="content">		  
				  ...
				  <tbody>					
						<tr>
						  <th width="130"><div>Tape Out Date From &#13;</div></th>
						  <td width="130">
