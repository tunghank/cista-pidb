...
function doSave() {
		...
		setMessage("error", "Updating WLO Material...");	
...
<body>
<% 
	WloTo ref = (WloTo)request.getAttribute("wloTo");
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
		<td class="pageTitle">Master Data :: Modify WLO Material</td>
		
  </tr>
</table>
			<div class="content">
			<form id="createForm" action="<%=cp%>/md/wlo_edit.do" method="post">
