...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="pageTitle">Master Data :: FLASHRAM Query</td>
  </tr>
</table>
	<div class="content">
	<form id="masterDataQueryForm" action="<%=cp%>/md/zs_flashram_query.do?m=query" method="post">
			...
			<table class="formFull"  border="0" cellpadding="1" cellspacing="1">
				<tbody>
					...
					<tr>
					<th width="180">FLASHRAM Vendor</th>
					  <% 
						...
						%>
						<td><input class="text" type="text" readonly id="flashramVendor" name="flashramVendor"  value=""  width="150px"> <img
							src="<%=cp%>/images/lov.gif" alt="LOV" id="flashramVendorSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"flashramVendorSSBtn",
                                inputField:"flashramVendor",
                                table:"WM_SAP_MASTER_VENDOR",
                                keyColumn:"SHORT_NAME",
                                columns:"SHORT_NAME,VENDOR_CODE",
                                autoSearch:false,
                                title:"FLASHRAM VENDOR"
							});
							</script>
					  </td>
					</tr>
