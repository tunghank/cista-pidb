...
function doSave() {
	...
	new Ajax.Request(
		...
		{
			method: 'get',
			parameters: 'projCodeWVersion='+ $F('projCodeWVersion') + '&raTestItem=' + $F('raTestItem'),
...
<form name="updateForm" action="<%=cp %>/md/htol_ra_create.do?m=save" method="post">
	...
	<tbody>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="pageTitle">Master Data :: Create HTOL RA</td>
				</tr>
			</table>
			<div class="content">
				...
				<tbody>
					<tr>
						<th width="20%"><div><span class="star">*</span> Product Code</div></th>
					 	<td width="30%"><input class="text_required" type="text" readonly="true" id="prodCode" name="prodCode" value="" width="150px"> <img
					...
					<tr>
						<th width="20%"><div><span class="star">*</span> Project Code w Version</div></th>
					  	<td width="30%"><input class="text_required" type="text" readonly id="projCodeWVersion" name="projCodeWVersion"  value=""  width="150px"> <img
							...
							SmartSearch.setup({
                                ...
                                table:"PIDB_IC_WAFER a",
                                keyColumn:"PROJ_CODE_W_VERSION",
                                columns:"PROJ_CODE_W_VERSION",
                                title:"Project Code w Version",
                                autoSearch:false,
								mode:0,
								whereCause:" a.proj_code in (select b.PROJ_CODE from pidb_ic_fg b where b.prod_code={prodCode})"
							});
							</script>
							</td>
						<th width="20%"><div>RA plan start date</div></th>
					  	<td width="30%"><input type="text" class="text" readonly name="raPlanStartDate" id="raPlanStartDate" value="<%=BeanHelper.getHtmlValueByColumn(ref, "RA_PLAN_START_DATE", "yyyy/MM/dd") %>" 
					  		width="150px" 
							onchange="addDate ($('testTime168Hr'),10);addDate ($('testTime500Hr'),27);addDate ($('testTime1000Hr'),51);addDate ($('rptCompleteTime'),54);addDate ($('raPlanFinishDate'),54);">
							<img
							src="<%=cp%>/images/calendar.gif" alt="Calendar" width="19"
						...
						&nbsp;
						<input name="clearDateBtn" type="button" class="clrDate_button" id="clearDateBtn" value="Clear" onClick="doPlanStartDate()">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th width="20%"><div>Customer</div></th>
					  	<td width="30%"><textarea type="text" class="text_protected" cols="49" rows="1" readonly name="cust" id="cust" width="150px"> <%=BeanHelper.getHtmlValueByColumn(ref, "CUST") %></textarea>
						...
						<th width="20%"><div>RA real start date</div></th>
					 	<td width="30%">
							<input type="text" class="text" readonly name="raRealStartDate" id="raRealStartDate" value="<%=BeanHelper.getHtmlValueByColumn(ref, "RA_REAL_START_DATE", "yyyy/MM/dd") %>" width="150px" 
							onChange= "dateChange1(raRealStartDate.value)">
						...
						&nbsp;
						<input name="clearDateBtn" type="button" class="clrDate_button" id="clearDateBtn" value="Clear" onClick="dateChange2()">
						</td>
					</tr>			
					<tr>
					...
					<tr>
						...
						<th width="20%"><div>RA report ready date</div></th>
					  	<td width="30%"><input type="text" class="text" readonly name="rptCompleteTime" id="rptCompleteTime" value="<%=BeanHelper.getHtmlValueByColumn(ref, "RPT_COMPLETE_TIME", "yyyy/MM/dd") %>" width="150px">
							<img
							src="<%=cp%>/images/calendar.gif" alt="Calendar" width="19"
					...
					<tr>
						<th width="20%"><div>&nbsp;</div></th>
					  	<td width="30%"><input type="hidden" class="text" readonly name="savedate" id="savedate" ></td>																
					</tr>
				</tbody>
			</table>
