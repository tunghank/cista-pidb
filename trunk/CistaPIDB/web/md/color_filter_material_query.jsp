...
<body>
<form id="cpMaterialQueryForm" action="<%=cp %>/md/color_filter_material_query.do?m=query" method="post">	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="pageTitle">Master Data :: Color Filter Material Query</td>
  </tr>
</table>
			<div class="content">
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					<tr>
						<th width="180"><div>Color Filter Material Num.</div></th>
					  <td><input class="text" type="text" id="colorFilterMaterialNum" name="colorFilterMaterialNum">
					  <img src="<%=cp%>/images/lov.gif" alt="LOV" id="colorFilterMaterialNumSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"colorFilterMaterialNumSSBtn",
                                inputField:"colorFilterMaterialNum",
					...
					<tr>
					  ...
					  <img src="<%=cp%>/images/lov.gif" alt="LOV" id="projectCodeWVersionSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"projectCodeWVersionSSBtn",
					...
					<tr>
						<th width="180">Color Filter VARIANT</th>
					  <td><input class="text" type="text" id="ColorFilterVariant" name="ColorFilterVariant" >
					  <img src="<%=cp%>/images/lov.gif" alt="LOV" id="ColorFilterVariantSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"ColorFilterVariantSSBtn",
                                inputField:"ColorFilterVariant",
                                table:"PIDB_COLOR_FILTER_MATERIAL",
                                keyColumn:"COLOR_FILTER_VARIANT",
                                title:"COLOR FILTER VARIANT",
                                mode:1
							});
