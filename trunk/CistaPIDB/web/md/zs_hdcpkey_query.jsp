...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="pageTitle">Master Data :: HDCP KEY Query</td>
  </tr>
</table>
	<div class="content">
	<form id="masterDataQueryForm" action="<%=cp%>/md/zs_hdcpkey_query.do?m=query" method="post">
			...
			<table class="formFull"  border="0" cellpadding="1" cellspacing="1">
				<tbody>
					...
					<tr>
					<th width="180">HDCP KEY Vendor</th>
						<td><input class="text" type="text" readonly id="hdcpKeyVendor" name="hdcpKeyVendor"  value=""  width="150px"> <img
							src="<%=cp%>/images/lov.gif" alt="LOV" id="hdcpKeyVendorVendorSSBtn">
							<script type="text/javascript">
							SmartSearch.setup({
                                cp:"<%=cp%>",
                                button:"hdcpKeyVendorVendorSSBtn",
                                inputField:"sdramVendor",
                                table:"WM_SAP_MASTER_VENDOR",
                                keyColumn:"SHORT_NAME",
                                columns:"SHORT_NAME,VENDOR_CODE",
                                autoSearch:false,
                                title:"HDCP KEY VENDOR"
							});
							</script>
					  </td>
					</tr>
