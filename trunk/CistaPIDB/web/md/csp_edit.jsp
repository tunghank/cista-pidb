...
<%@ page import="com.cista.pidb.md.to.CspTo" %>
...
function doSave() {
		...
		if ($F('cspType') == "") {
			setMessage("error", "CSP Package Type is must field.");
			$('isRelease').value='0';	
			return;
		}
		...
		setMessage("error", "Updating CSP package...");	
...
<body>
<% 
	CspTo ref = (CspTo)request.getAttribute("cspTo");	
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
		<td class="pageTitle">Master Data :: Modify Csp Package</td>
		
  </tr>
</table>
			<div class="content">
			<form id="createForm" action="<%=cp%>/md/csp_edit.do" method="post">
			...
			<table class="formFull" border="0" cellpadding="1" cellspacing="1">
				<tbody>
					<tr>
					    ...
					    <td width="30%">
						<input class="text_protected" type="text" name="projName" id="projName" readonly
						value="<%=BeanHelper.getHtmlValueByColumn(ref,"PROJ_NAME") %>">&nbsp;</td>
					...
					<tr>
					  ...
					  <td><input class="text_protected" type="text" name="pkgName" id="pkgName" 
					    value="<%=BeanHelper.getHtmlValueByColumn(ref,"PKG_NAME")%>" readonly></td>
					  <th>Assembly House 2 Spec No</th>
					  <td><input class="text" type="text" name="assyHouse2SpecNum" id="assyHouse2SpecNum"  width="150px"
					 ...
					 <select class="select_w130" name="pkgCode" id="pkgCode">
						<option value="">--Select--</option>
								...
								for (FunctionParameterTo version : versionList) 
								{
									...
									String selected = "";
									if (v.equals(BeanHelper.getHtmlValueByColumn(ref,"PKG_CODE")))
									{
										selected = "selected";
									}
								%>
					...
					<tr>
						<th><div class="erp_label"><span class="star">*</span> Csp Package Type</div></th>
						<td>
						<input class="text" type="text" name="cspType" id="cspType"
					  value="<%=BeanHelper.getHtmlValueByColumn(ref,"CSP_TYPE") %>" >
						</td>
					...
					<tr>
                     ...
                     <tr>
					  ...
					  value="<%=BeanHelper.getHtmlValueByColumn(ref,"ASSY_HOUSE1_SPEC_NUM") %>" >
